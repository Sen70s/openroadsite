<template>
    <div id="ComputerView">
        <div id="content" style="padding:50px;" align="center">
            <img src="../assets/image/tuojie_logo.png" style="width: 150px;border-radius: 60px;margin-top: 30px;">
            <h1 >
                <span id="productName"  style="font-size: 85px;">启麓</span>
                <span id="productName"  style="font-size: 60px;">OpenRoad</span>
            </h1>
            ...
            <vs-row class="mh" align="center" justify="space-around" direction="column">
                <vs-col>
                    <vs-row justify="center" align="center">
                        <vs-col w="12">
                            <vs-button-group>
                            <vs-button icon color="dribbble" size="xl" flat style="padding: 20px;width: calc(100%);"
                ...
                <vs-col style="margin-top: 15px;margin-bottom: 15px;">
                ...
                <vs-col >
                    <vs-row justify="space-around" align="center">
                        <vs-col w="12">
                            <vs-button icon color="twitter" size="xl" flat style="padding: 20px; width: calc(100%);"
        ...
        openDownloadAlert(type) {
            if (type != "android") {
                ...
                if (this.is_andriod_ios.ios) {
                    ...
                    const fileUrl = "http://www.tuojiekj.top/assets/app/openroad.apk"; // 文件的URL地址
